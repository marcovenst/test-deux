...
-- Image URLs are Amazon og:image URLs (verify listings still match after Amazon CDN changes).
...
(
  ...
  0,
  'usd',
  array['https://m.media-amazon.com/images/I/81LSfUZqhdL._AC_PT0_BL0_SX216_SY110_FMwebp_QL25_.jpg']::text[],
  'external_affiliate',
...
(
  ...
  0,
  'usd',
  array['https://m.media-amazon.com/images/I/61RPfoW28HL._AC_QL10_SX980_SY55_FMwebp_.jpg']::text[],
  'external_affiliate',
...
(
  ...
  0,
  'usd',
  array['https://m.media-amazon.com/images/I/51-48al4Y6L._AC_PT0_BL0_SY110_FMwebp_QL25_.jpg']::text[],
  'external_affiliate',
...
(
  ...
  0,
  'usd',
  array['https://m.media-amazon.com/images/I/61NcKNERXIL._AC_QL10_SX980_SY55_FMwebp_.jpg']::text[],
  'external_affiliate',
...
(
  ...
  0,
  'usd',
  array['https://m.media-amazon.com/images/I/6122ep9XBSL.jpg']::text[],
  'external_affiliate',
...
(
  ...
  0,
  'usd',
  array['https://m.media-amazon.com/images/I/71f7bN68jvL._AC_QL10_SX980_SY55_FMwebp_.jpg']::text[],
  'external_affiliate',
...
(
  ...
  0,
  'usd',
  array['https://m.media-amazon.com/images/I/51jxm3pQYRL.jpg']::text[],
  'external_affiliate',
...
(
  ...
  0,
  'usd',
  array['https://m.media-amazon.com/images/I/91h4WTAycXL._AC_PT0_BL0_SX216_SY110_FMwebp_QL25_.jpg']::text[],
  'external_affiliate',
...
(
  ...
  0,
  'usd',
  array['https://m.media-amazon.com/images/I/71OIhEpBJcL._AC_PT0_BL0_SX216_SY110_FMwebp_QL25_.jpg']::text[],
  'external_affiliate',
...
(
  ...
  0,
  'usd',
  array['https://m.media-amazon.com/images/I/51F8j5gqoAL._AC_QL10_SX980_SY55_FMwebp_.jpg']::text[],
  'external_affiliate',
